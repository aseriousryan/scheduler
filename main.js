...
app.post("/trigger-api", (req, res) => {
	const { question, database_name, cron_input, second_function, contact_num, company_id, question_name, use_case, sub_use_case } = req.body;

	const requiredFields = ["question", "database_name", "cron_input", "second_function", "contact_num", "company_id", "question_name", "use_case", "sub_use_case"];
...
app.patch("/update", (req, res) => {
	const { id, cron_input, question, contact_num, company_id, question_name, use_case, sub_use_case } = req.body;

	const requiredFields = ["id", "question", "cron_input", "contact_num", "company_id", "question_name", "use_case", "sub_use_case"];
